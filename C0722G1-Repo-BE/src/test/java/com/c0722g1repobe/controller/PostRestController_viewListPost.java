...
public class PostRestController_viewListPost {
    ...
    public void getListPost_6() throws Exception {
        ...
        this.mockMvc.perform(
                ...
                .andExpect(jsonPath("content[0].numberAddress").value("123 Trần Hưng Đạo"))
                .andExpect(jsonPath("content[0].nameWards").value("Hải Châu I"))
                .andExpect(jsonPath("content[0].nameDistrict").value("Hải Châu"))
                .andExpect(jsonPath("content[0].nameCity").value("Đà Nẵng"))
                .andExpect(jsonPath("content[0].yearPost").value("2023"))
                .andExpect(jsonPath("content[0].monthPost").value("02"))
                .andExpect(jsonPath("content[4].idPost").value(2))
                ...
                .andExpect(jsonPath("content[4].numberAddress").value("135 Lê Lợi"))
                .andExpect(jsonPath("content[4].nameWards").value("Hương Xuân"))
                .andExpect(jsonPath("content[4].nameDistrict").value("Hương Trà"))
