    ...
    public void getAllEmployee_7() throws Exception {
        ...
        this.mockMvc.perform(
                        MockMvcRequestBuilders
                                .get("/api/posts?demandTypeSearch=null&lendTypeSearch=null&minSearch=null&maxSearch=null&positionSearch=null&page=0"))
                .andDo(print())
...
public void getListPost_6() throws Exception {
    ...
    public void getListPost_demandType_11() throws Exception {
        this.mockMvc.perform(
                        MockMvcRequestBuilders.get("/api/posts?demandTypeSearch=Mua&lendTypeSearch=&minSearch=&maxSearch=&positionSearch=&page=0"))
                .andDo(print())
                .andExpect(status().is2xxSuccessful())
    ...
    public void getListPost_landType_11() throws Exception {
        this.mockMvc.perform(
                        MockMvcRequestBuilders.get("/api/posts?demandTypeSearch=&lendTypeSearch=Đất&minSearch=&maxSearch=&positionSearch=&page=0"))
                .andDo(print())
                .andExpect(status().is2xxSuccessful())
                .andExpect(jsonPath("totalPages").value(1))
    ...
    /**
     * This function use to test list post of all field search with price betwwen 100 and 1000, page = 0
     *
     * @author NgocLV
     * @Date 01/02/2023
     */
    @Test
    public void getListPost_price_11() throws Exception {
        this.mockMvc.perform(
                        MockMvcRequestBuilders.get("/api/posts?demandTypeSearch=&lendTypeSearch=&minSearch=100&maxSearch=1000&positionSearch=&page=0"))
                .andDo(print())
                .andExpect(status().is2xxSuccessful())
                .andExpect(jsonPath("totalPages").value(1))
                .andExpect(jsonPath("totalElements").value(2))
                .andExpect(jsonPath("content[0].area").value(3000))
                .andExpect(jsonPath("content[0].codeCustomer").value("KH065"))
                .andExpect(jsonPath("content[0].landType").value("Đất"))
                .andExpect(jsonPath("content[0].demandType").value("Bán"))
                .andExpect(jsonPath("content[0].price").value(300))
                .andExpect(jsonPath("content[0].note").value("Cần mua đất mặt tiền"))
                .andExpect(jsonPath("content[1].area").value(4000))
                .andExpect(jsonPath("content[1].codeCustomer").value("KH070"))
                .andExpect(jsonPath("content[1].landType").value("Đất"))
                .andExpect(jsonPath("content[1].demandType").value("Bán"))
                .andExpect(jsonPath("content[1].price").value(700))
                .andExpect(jsonPath("content[1].note").value("Cần mua đất mặt tiền"));
    }
    /**
     * This function use to test list post of all field search with position in Đà Nẵng, page = 0
     *
     * @author NgocLV
     * @Date 01/02/2023
     */
    @Test
    public void getListPost_position_11() throws Exception {
        this.mockMvc.perform(
                        MockMvcRequestBuilders.get("/api/posts?demandTypeSearch=&lendTypeSearch=&minSearch=&maxSearch=&positionSearch=Đà Nẵng&page=0"))
                .andDo(print())
                .andExpect(status().is2xxSuccessful())
                .andExpect(jsonPath("totalPages").value(1))
                .andExpect(jsonPath("totalElements").value(2))
                ...
                .andExpect(jsonPath("content[0].price").value(300))
                .andExpect(jsonPath("content[0].note").value("Cần mua đất mặt tiền"))
                .andExpect(jsonPath("content[0].position").value("Đà Nẵng"))
                .andExpect(jsonPath("content[1].area").value(4000))
                .andExpect(jsonPath("content[1].codeCustomer").value("KH070"))
                .andExpect(jsonPath("content[1].landType").value("Đất"))
                .andExpect(jsonPath("content[1].demandType").value("Bán"))
                .andExpect(jsonPath("content[1].price").value(700))
                .andExpect(jsonPath("content[1].note").value("Cần mua đất mặt tiền"))
                .andExpect(jsonPath("content[1].position").value("Đà Nẵng"));
    }
}
