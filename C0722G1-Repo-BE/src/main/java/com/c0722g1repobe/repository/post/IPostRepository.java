...
public interface IPostRepository extends JpaRepository<Post, Long> {
    @Query(value = "SELECT * FROM post p\n" +
            ...
            "    JOIN image_list il on il.id_image_list = p.image_list_id_image_list\n" +
            ...
            countQuery = "SELECT * FROM post p\n" +
                    ...
                    "  AND d.name_direction LIKE CONCAT('%', :direction, '%')\n" +
                    "  AND c2.name_city LIKE CONCAT('%', :city, '%')")
    Page<Post> findAllWithDemandTypeDirectionCity(@Param("demandType") String demandType,
    ...
    @Query(value = "SELECT * FROM post p\n" +
            ...
            countQuery = "SELECT * FROM post p\n" +
                    ...
                    "  AND c2.name_city LIKE CONCAT('%',:city,'%')\n" +
                    "  AND p.area BETWEEN :minArea AND :maxArea")
    Page<Post> findAllWithDemandTypeDirectionCityArea(@Param("demandType") String demandType,
                                                      @Param("direction") String direction,
    ...
    Page<Post> findAllWithDemandTypeDirectionCityPrice(@Param("demandType") String demandType,
                                                      @Param("direction") String direction,
                                                      @Param("city") String city,
    ...
    @Query(value = "SELECT * FROM post p\n" +
            ...
            countQuery = "SELECT * FROM post p\n" +
                    ...
                    "  AND p.area BETWEEN :minArea AND :maxArea \n" +
                    "  AND p.price BETWEEN :priceMin AND :priceMax")
    Page<Post> findAllWithDemandTypeDirectionCityAreaPrice(@Param("demandType") String demandType,
                                                           @Param("direction") String direction,
                                                           @Param("city") String city,
                                                           @Param("minArea") Double minArea,
